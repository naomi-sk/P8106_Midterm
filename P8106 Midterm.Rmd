...
training_data$gender <- factor(training_data$gender, levels = c(0, 1), 
                               labels = c("Female", "Male"))
training_data$race <- factor(training_data$race, levels = c(1,2,3,4), 
                             labels = c("White", "Asian", "Black", "Hispanic"))
training_data$smoking <- factor(training_data$smoking, levels = c(0, 1, 2), 
                               labels = c("Never", "Former", "Current"))
training_data$diabetes <- factor(training_data$diabetes, levels = c(0, 1), 
                                 labels = c("No", "Yes"))
training_data$hypertension <- factor(training_data$hypertension, levels = c(0, 1), 
                                     labels = c("No", "Yes"))


# Do the same for validation dataset
# Convert to factor with meaningful labels
testing_data$gender <- factor(testing_data$gender, levels = c(0, 1), labels = c("Female", "Male"))
testing_data$race <- factor(testing_data$race, levels = c(1,2,3,4), 
                             labels = c("White", "Asian", "Black", "Hispanic"))
testing_data$smoking <- factor(testing_data$smoking, levels = c(0, 1, 2), 
                               labels = c("Never", "Former", "Current"))
testing_data$diabetes <- factor(testing_data$diabetes, levels = c(0, 1), 
                                 labels = c("No", "Yes"))
testing_data$hypertension <- factor(testing_data$hypertension, levels = c(0, 1), 
                                     labels = c("No", "Yes"))
